        ...
        <div className="container mx-auto px-6 md:px-12">
          <div className="flex flex-col md:flex-row gap-12 md:gap-20 items-start justify-between max-w-5xl mx-auto">
            ...
            <div className="w-full md:w-2/3 text-base md:text-lg text-stone-600 font-light leading-relaxed space-y-8 text-balance">
              ...
              <p>
                We don't chase fast-moving trends. Instead, we design pieces that are unique, 
                versatile, and meant to become part of your personal story—treasures you'll 
              ...
              <p>
                ...
                the traditional markups. The result? Jewelry that's affordable, meaningful, 
